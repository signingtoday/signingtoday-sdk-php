...
class SignaturesApi
{
     ...
     */
    public function declineDST($organization_id, $signature_id, $inline_object2)
    {
        list($response) = $this->declineDSTWithHttpInfo($organization_id, $signature_id, $inline_object2);
        return $response;
    }
     ...
     */
    public function declineDSTWithHttpInfo($organization_id, $signature_id, $inline_object2)
    {
        $request = $this->declineDSTRequest($organization_id, $signature_id, $inline_object2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function declineDSTAsync($organization_id, $signature_id, $inline_object2)
    {
        return $this->declineDSTAsyncWithHttpInfo($organization_id, $signature_id, $inline_object2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function declineDSTAsyncWithHttpInfo($organization_id, $signature_id, $inline_object2)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2013';
        $request = $this->declineDSTRequest($organization_id, $signature_id, $inline_object2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function declineDSTRequest($organization_id, $signature_id, $inline_object2)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inline_object2 === null || (is_array($inline_object2) && count($inline_object2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inline_object2 when calling declineDST'
            );
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2008|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse2008|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2009|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse2009|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20010|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20010|\OpenAPI\Client\Model\InlineResponse404|\OpenAPI\Client\Model\InlineResponse401|\OpenAPI\Client\Model\InlineResponse403|\OpenAPI\Client\Model\InlineResponse404, HTTP status code, HTTP response headers (array of strings)
     */
