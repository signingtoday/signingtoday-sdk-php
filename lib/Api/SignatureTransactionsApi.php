...
/**
 * SignatureTransactionsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SignatureTransactionsApi
{
    /**
     * @var ClientInterface
     */
     ...
     */
    public function cancelDST($organization_id, $dst_id, $inline_object1)
    {
        list($response) = $this->cancelDSTWithHttpInfo($organization_id, $dst_id, $inline_object1);
        return $response;
    }
     ...
     */
    public function cancelDSTWithHttpInfo($organization_id, $dst_id, $inline_object1)
    {
        $request = $this->cancelDSTRequest($organization_id, $dst_id, $inline_object1);
     ...
     */
    public function cancelDSTAsync($organization_id, $dst_id, $inline_object1)
    {
        return $this->cancelDSTAsyncWithHttpInfo($organization_id, $dst_id, $inline_object1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelDSTAsyncWithHttpInfo($organization_id, $dst_id, $inline_object1)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2013';
        $request = $this->cancelDSTRequest($organization_id, $dst_id, $inline_object1);
     ...
     */
    protected function cancelDSTRequest($organization_id, $dst_id, $inline_object1)
    {
        ...
        if ($inline_object1 === null || (is_array($inline_object1) && count($inline_object1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inline_object1 when calling cancelDST'
            );
        }
     ...
     */
    public function listDSTs($organization_id, $where_signer = null, $where_status = null, $where_title = null, $where_created_by = null, $where_created = null, $where_signature_status = null, $where_document_name = null, $where_reason = null, $where_signature_name = null, $where_signer_group = null, $page = null, $count = 100)
    {
        list($response) = $this->listDSTsWithHttpInfo($organization_id, $where_signer, $where_status, $where_title, $where_created_by, $where_created, $where_signature_status, $where_document_name, $where_reason, $where_signature_name, $where_signer_group, $page, $count);
        return $response;
    }
     ...
     */
    public function listDSTsWithHttpInfo($organization_id, $where_signer = null, $where_status = null, $where_title = null, $where_created_by = null, $where_created = null, $where_signature_status = null, $where_document_name = null, $where_reason = null, $where_signature_name = null, $where_signer_group = null, $page = null, $count = 100)
    {
        $request = $this->listDSTsRequest($organization_id, $where_signer, $where_status, $where_title, $where_created_by, $where_created, $where_signature_status, $where_document_name, $where_reason, $where_signature_name, $where_signer_group, $page, $count);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDSTsAsync($organization_id, $where_signer = null, $where_status = null, $where_title = null, $where_created_by = null, $where_created = null, $where_signature_status = null, $where_document_name = null, $where_reason = null, $where_signature_name = null, $where_signer_group = null, $page = null, $count = 100)
    {
        return $this->listDSTsAsyncWithHttpInfo($organization_id, $where_signer, $where_status, $where_title, $where_created_by, $where_created, $where_signature_status, $where_document_name, $where_reason, $where_signature_name, $where_signer_group, $page, $count)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDSTsAsyncWithHttpInfo($organization_id, $where_signer = null, $where_status = null, $where_title = null, $where_created_by = null, $where_created = null, $where_signature_status = null, $where_document_name = null, $where_reason = null, $where_signature_name = null, $where_signer_group = null, $page = null, $count = 100)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2006';
        $request = $this->listDSTsRequest($organization_id, $where_signer, $where_status, $where_title, $where_created_by, $where_created, $where_signature_status, $where_document_name, $where_reason, $where_signature_name, $where_signer_group, $page, $count);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listDSTsRequest($organization_id, $where_signer = null, $where_status = null, $where_title = null, $where_created_by = null, $where_created = null, $where_signature_status = null, $where_document_name = null, $where_reason = null, $where_signature_name = null, $where_signer_group = null, $page = null, $count = 100)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($count !== null && $count > 100) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling SignatureTransactionsApi.listDSTs, must be smaller than or equal to 100.');
        }
        if ($count !== null && $count < 1) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling SignatureTransactionsApi.listDSTs, must be bigger than or equal to 1.');
        }
