...
/**
 * CreateTokenWebhooks Class Doc Comment
 *
 * @category Class
 * @description SigningToday supports webhooks for the update of digital signature transactions and identities status. You can choose if to use or not webhooks and if you want to receive updates about digital signature transactions and/or identities. You can configurate it on application token level, in the _webhook field_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateTokenWebhooks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateToken_webhooks';
     ...
     * Sets dst
     *
     * @param string|null $dst The url where to receive notifications about digital signature transaction status
     *
     * @return $this
     */
     ...
     * Sets identity
     *
     * @param string|null $identity The url where to receive notifications about identity status
     *
     * @return $this
     */
