...
class UpdateOrganization implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrganization';
    ...
    protected static $openAPIFormats = [
        'default_rao' => 'any',
        'dst_default_months' => 'integer',
        'logo' => 'url',
        'name' => 'any',
        'signature_appearance' => 'url'
    ];
    ...
    protected static $attributeMap = [
        ...
        'dst_default_months' => 'dst_default_months',
        'logo' => 'logo',
        'name' => 'name',
    ...
    protected static $setters = [
        'default_rao' => 'setDefaultRao',
        'dst_default_months' => 'setDstDefaultMonths',
        'logo' => 'setLogo',
        'name' => 'setName',
        'signature_appearance' => 'setSignatureAppearance'
    ];
    ...
    protected static $getters = [
        'default_rao' => 'getDefaultRao',
        'dst_default_months' => 'getDstDefaultMonths',
        'logo' => 'getLogo',
        'name' => 'getName',
        'signature_appearance' => 'getSignatureAppearance'
    ];
    ...
    {
        $this->container['default_rao'] = isset($data['default_rao']) ? $data['default_rao'] : null;
        $this->container['dst_default_months'] = isset($data['dst_default_months']) ? $data['dst_default_months'] : 3;
        $this->container['logo'] = isset($data['logo']) ? $data['logo'] : null;
        $this->container['name'] = isset($data['name']) ? $data['name'] : null;
        $this->container['signature_appearance'] = isset($data['signature_appearance']) ? $data['signature_appearance'] : null;
    }
     ...
     * @return string|null
     */
    public function getDefaultRao()
    {
        return $this->container['default_rao'];
    }

    /**
     * Sets default_rao
     *
     * @param string|null $default_rao This is the default *RAO* user of the Organization. A rao user is the one can associate identities to the other users
     *
     * @return $this
     */
    public function setDefaultRao($default_rao)
    {
        $this->container['default_rao'] = $default_rao;

        return $this;
    }

    /**
     * Gets dst_default_months
     *
     * @return int|null
     */
    public function getDstDefaultMonths()
    {
        return $this->container['dst_default_months'];
    }

    /**
     * Sets dst_default_months
     *
     * @param int|null $dst_default_months This is the default deadline before the expiration of a digital signature transaction
     *
     * @return $this
     */
    public function setDstDefaultMonths($dst_default_months)
    {
        $this->container['dst_default_months'] = $dst_default_months;
     ...
     * Sets logo
     *
     * @param string|null $logo This is the url to the image is supposed to be used as logo of the Organization, for example the logo or the motto of the company is integrating SigningToday
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name This is an arbitrary name is possible to associate to the Organization
     *
     * @return $this
     */
    ...
    /**
     * Gets signature_appearance
     *
     * @return string|null
     */
    public function getSignatureAppearance()
    {
        return $this->container['signature_appearance'];
    }

    /**
     * Sets signature_appearance
     *
     * @param string|null $signature_appearance This is the url to the default signature appearance will be used for every member of the organization. In the scenario of a user that owns an identity with a signature_appearance will be uset the image associated to the identity rather than the default one
     *
     * @return $this
     */
    public function setSignatureAppearance($signature_appearance)
    {
        $this->container['signature_appearance'] = $signature_appearance;
