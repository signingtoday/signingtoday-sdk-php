...
class Signature implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $signature_ticket This is the url where a signature tray is predisposed for a specific signer that have to sign a specific digital signature transaction
     *
     * @return $this
     */
