...
/**
 * SignatureDST Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SignatureDST implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureDST';
    ...
    protected static $openAPITypes = [
        ...
        'signer' => 'string',
        'urlback' => 'string',
        'where' => '\OpenAPI\Client\Model\SignatureDSTWhere'
    ];
     ...
     * Gets where
     *
     * @return \OpenAPI\Client\Model\SignatureDSTWhere|null
     */
     ...
     * Sets where
     *
     * @param \OpenAPI\Client\Model\SignatureDSTWhere|null $where where
     *
     * @return $this
     */
