...
/**
 * CreateTokenHttpOptions Class Doc Comment
 *
 * @category Class
 * @description Through this field it is possible to add some custom options to the HTTP request
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateTokenHttpOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateToken_http_options';
     ...
     * Sets auth_mode
     *
     * @param string|null $auth_mode The mode of the authentication
     *
     * @return $this
     */
     ...
     * Sets auth_password
     *
     * @param string|null $auth_password The password for the HTTP basic authentication
     *
     * @return $this
     */
     ...
     * Sets auth_username
     *
     * @param string|null $auth_username The username for the HTTP basic authentication
     *
     * @return $this
     */
     ...
     * Sets client_cert
     *
     * @param string|null $client_cert the SSL client certificate
     *
     * @return $this
     */
     ...
     * Sets client_key
     *
     * @param string|null $client_key The SSL client key
     *
     * @return $this
     */
     ...
     * Sets headers
     *
     * @param object|null $headers Key-Value pairs that identifies headers to add to the HTTP request
     *
     * @return $this
     */
