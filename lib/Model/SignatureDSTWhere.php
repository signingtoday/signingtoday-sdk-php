...
/**
 * SignatureDSTWhere Class Doc Comment
 *
 * @category Class
 * @description Where will be allocated the Signature on the document. This field is made of two parameters, defined as follows
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SignatureDSTWhere implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureDST_where';
    ...
    protected static $openAPITypes = [
        ...
        'position' => 'string',
        'image_uri' => 'string',
        'text' => '\OpenAPI\Client\Model\SignatureWhereText[]'
    ];
     ...
     * Sets page
     *
     * @param int|null $page As can be guessed this is the page where to allocate the Signature
     *
     * @return $this
     */
     ...
     * Sets position
     *
     * @param string|null $position This is the exact position in the choosen page where to attach the Signature. Multiple unit of measurement are provided. The format is the following:   - \"rect: 50mm, 100mm, 200mm, 150mm\"
     *
     * @return $this
     */
     ...
     * Gets text
     *
     * @return \OpenAPI\Client\Model\SignatureWhereText[]|null
     */
