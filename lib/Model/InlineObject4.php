...
class InlineObject4 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'identity_id' => '\OpenAPI\Client\Model\Id',
        'session_id' => 'string'
    ];
     ...
     * Sets identity_id
     *
     * @param \OpenAPI\Client\Model\Id|null $identity_id identity_id
     *
     * @return $this
     */
     ...
     * Sets session_id
     *
     * @param string|null $session_id This is the id of the session is going to use in order the perform the signature or the signatures
     *
     * @return $this
     */
