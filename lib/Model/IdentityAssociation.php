...
/**
 * IdentityAssociation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class IdentityAssociation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentityAssociation';
    ...
    const PROVIDER_ID_ARUBA = 'aruba';
    const PROVIDER_ID_ARUBA_AUTO = 'aruba-auto';
    const PROVIDER_ID_INFOCERT = 'infocert';
    const PROVIDER_ID_NAMIRIAL = 'namirial';
    ...
    {
        return [
            self::PROVIDER_ID_ARUBA,
            self::PROVIDER_ID_ARUBA_AUTO,
            self::PROVIDER_ID_INFOCERT,
            self::PROVIDER_ID_NAMIRIAL,
        ];
    }
