 ...
 *
 * @category Class
 * @description The Pagination is an object that helps to serialize response content in terms of number and pages of elements. This way is possible to easily manipulate through big amount of data
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaginationData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pagination-data';
