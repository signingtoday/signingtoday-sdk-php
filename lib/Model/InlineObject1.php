...
class InlineObject1 implements ModelInterface, ArrayAccess
{
     ...
     * Sets reason
     *
     * @param string|null $reason This is the actual reason why the Digital Signature Transaction is going to be canceled, to be provided in the body of the request
     *
     * @return $this
     */
