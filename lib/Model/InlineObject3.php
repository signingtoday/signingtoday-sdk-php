...
class InlineObject3 implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'channel_pub' => 'setChannelPub',
        'channel_sub' => 'setChannelSub'
    ];
    ...
    protected static $getters = [
        'channel_pub' => 'getChannelPub',
        'channel_sub' => 'getChannelSub'
    ];
    ...
    {
        $this->container['channel_pub'] = isset($data['channel_pub']) ? $data['channel_pub'] : null;
        $this->container['channel_sub'] = isset($data['channel_sub']) ? $data['channel_sub'] : null;
    }
     ...
     * @return string|null
     */
    public function getChannelPub()
    {
        return $this->container['channel_pub'];
    }

    /**
     * Sets channel_pub
     *
     * @param string|null $channel_pub The channel pub
     *
     * @return $this
     */
    public function setChannelPub($channel_pub)
    {
        $this->container['channel_pub'] = $channel_pub;
     ...
     * @return string|null
     */
    public function getChannelSub()
    {
        return $this->container['channel_sub'];
    }

    /**
     * Sets channel_sub
     *
     * @param string|null $channel_sub The channel sub
     *
     * @return $this
     */
    public function setChannelSub($channel_sub)
    {
        $this->container['channel_sub'] = $channel_sub;
