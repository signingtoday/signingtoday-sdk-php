 ...
 *
 * @category Class
 * @description SMS provider data is needed to supply in order to create an identity issued by SMS
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SMS implements ModelInterface, ArrayAccess
{
     ...
     * Sets birth_country
     *
     * @param string|null $birth_country Country of birth of the identity
     *
     * @return $this
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime|null $birth_date Birthdate of the identity
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email Email address associated to the identity
     *
     * @return $this
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name First name of the identity
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Last name of the identity
     *
     * @return $this
     */
     ...
     * Sets phone_mobile
     *
     * @param string|null $phone_mobile Phone number associated to the identity
     *
     * @return $this
     */
