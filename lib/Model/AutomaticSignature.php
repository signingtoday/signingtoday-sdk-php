...
/**
 * AutomaticSignature Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AutomaticSignature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomaticSignature';
    ...
    {
        $this->container['password'] = isset($data['password']) ? $data['password'] : 'bit4idtest';
    }
     ...
     * Sets password
     *
     * @param string|null $password This is the _password_ to enable the automatic signature. Every automatic signer has its own password, to provide as body during the performance of an automatic signature
     *
     * @return $this
     */
