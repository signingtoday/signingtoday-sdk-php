...
class IdentityRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'provider_id' => 'string',
        'label' => 'string',
        'provider_data' => '\OpenAPI\Client\Model\SMS',
    ...
    const PROVIDER_ID_SMS = 'sms';
    const PROVIDER_ID_ST_APPROVAL = 'st-approval';
     ...
     * @return string[]
     */
    public function getProviderIdAllowableValues()
    {
        return [
            self::PROVIDER_ID_SMS,
            self::PROVIDER_ID_ST_APPROVAL,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getProviderIdAllowableValues();
        if (!is_null($this->container['provider_id']) && !in_array($this->container['provider_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'provider_id', must be one of '%s'",
     ...
     * Sets user
     *
     * @param string|null $user The user is intended to associate the requestd identity
     *
     * @return $this
     */
     ...
     * Sets provider_id
     *
     * @param string|null $provider_id The id of the provider will issue the requested identity
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getProviderIdAllowableValues();
        if (!is_null($provider_id) && !in_array($provider_id, $allowedValues, true)) {
     ...
     * Gets provider_data
     *
     * @return \OpenAPI\Client\Model\SMS|null
     */
     ...
     * Sets provider_data
     *
     * @param \OpenAPI\Client\Model\SMS|null $provider_data provider_data
     *
     * @return $this
     */
     ...
     * Sets registered_by
     *
     * @param string|null $registered_by The RAO user that registered the identity
     *
     * @return $this
     */
